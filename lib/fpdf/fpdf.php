...
function Image($file,$x,$y,$w=0,$h=0,$type='',$link='',$paint=true)
{
	...
	if(!isset($this->images[$file]))
	{
		...
		elseif($type=='gif')
		{
			$info=$this->_parsegif($file); //EDITEI - GIF format included
		}
		else
		{
			//Allow for additional formats
			if(substr($type, 0, 3) == 'php')
			{
				echo $file = 'http://dev174.coldtrick.com/mod/file/thumbnail.php?file_guid=7829&size=large';
				var_dump($file);
